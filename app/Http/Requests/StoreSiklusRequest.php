...
class StoreSiklusRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'blok_tanam'     => ['required', 'string', 'max:100'],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'blok_tanam.required'       => 'Blok tanam wajib diisi.',
            'blok_tanam.string'         => 'Blok tanam harus berupa teks.',
            'blok_tanam.max'            => 'Blok tanam maksimal 100 karakter.',
        ];
    }
